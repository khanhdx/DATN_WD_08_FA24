                ...
                <div class="col-md-12">
                    ...
                    <div class="d-flex justify-content-between mb-3">
                        <form class="" method="GET" style="width: 50%;">
                            <input class="form-control mb-3" type="text" name="search" value="{{$_GET['search']}}" placeholder="Tìm phiếu giảm giá theo tên hoặc mã">
                            <div class="row m-0" style="gap: 10px;">
                                <div class="col p-0">
                                    <label class="m-0 form-label" for="date_start">Từ ngày</label>
                                    <input name="date_start" id="date_start" value="{{$_GET['date_start']}}" type="date" class="form-control">
                                </div>
                                <div class="col p-0">
                                    <label class="m-0 form-label" for="date_end">Đến ngày</label>
                                    <input name="date_end" id="date_end" value="{{$_GET['date_end']}}" type="date" class="form-control">
                                </div>
                            </div>
                        </form>
