            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="au-breadcrumb-content">
                        <form action="{{ route('post.index') }}" class="au-form-icon--sm" action="" method="GET">
                        ...
                        <div class="table-data__tool-right">
                            <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                <a class="au-breadcrumb-span" href="{{ route('post.index') }}">Xóa tất cả các bộ lọc</a>
                            </button>
                        </div>
                        <div class="table-data__tool-right">
                            <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                <a class="au-breadcrumb-span" href="{{ route('post.create') }}">Thêm bài</a>
                            </button>
                        </div>
                    </div>
