...
<div class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            <h3 class="title-5 m-b-35">Quản lý Banner 2</h3>
            <div class="table-data__tool">
                <div class="table-data__tool-left">
                    <form action="{{ route('admin.slider.banner2.index') }}" method="get">
                        @csrf
                ...
                <div class="table-data__tool-right">
                    <a href="{{ route('admin.slider.banner2.create') }}"><button class="au-btn au-btn-icon au-btn--green au-btn--small">
                        <i class="zmdi zmdi-plus"></i>Thêm Banner 2</button></a>
                            ...
                            <tr class="tr-shadow">
                                ...
                                <td>
                                    <div class="table-data-feature d-flex align-items-center">
                                        <a href="{{ route('admin.slider.banner2.edit', $item->id) }}" class="mr-1">
                                            <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                <i class="zmdi zmdi-edit"></i>
                                            </button>
                                        </a>
                                        <form action="{{ route('admin.slider.banner2.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Bạn có muốn xóa không')" class="d-inline">
                                            @csrf
                                            @method('DELETE')
