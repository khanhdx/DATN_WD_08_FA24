        ...
        try {
            ...
            if ($productVariant->stock === 0) {
                return response()->json([
                    'message' => "Rất tiếc, cửa hàng chúng tôi hiện tại đang hết phân loại này!",
                    'status_code' => 500,
                ]);
            }
            ...
            if (Auth::check()) {
                ...
                if ($cart_item) {
                    ...
                    if ($cart_item->quantity > $productVariant->stock) {
                        return response()->json([
                            'message' => "Bạn đã có $quantity sản phẩm trong giỏ hàng. Không thể mua thêm vì QUÁ số lượng cho phép!",
                            'status_code' => 500,
                        ]);
                    }
